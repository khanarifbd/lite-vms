...
def certificate_pdf(vehicle: Vehicle, owner: VehicleOwner) -> BytesIO:
    ...
    draw_logo("btrc_1.png", 141, 1333.37, 130, 89.63)
    draw_logo("btrc_2.png", 168.47, 1293, 72.47, 23.02)
    draw_logo("btrc_3.png", 160.63, 1310.22, 89.81, 92.94)
    draw_logo("btrc_4.png", 171.62, 1347.83, 68.78, 22.78)
